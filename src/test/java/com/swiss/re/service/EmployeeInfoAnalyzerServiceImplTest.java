...
class EmployeeInfoAnalyzerServiceImplTest {
    ...
    @Test
    @Disabled("TODO: Complete this test")
    void testAnalyzeSalaries_givenEmployeeFirstNameIsJane() {
        // Arrange
        EmployeeInfoAnalyzerServiceImpl employeeInfoAnalyzerServiceImpl = new EmployeeInfoAnalyzerServiceImpl();
        ...
        // Act
        employeeInfoAnalyzerServiceImpl.analyzeSalaries(employee6, subordinatesAvgSalaries, new StringBuilder("foo"));
    }
